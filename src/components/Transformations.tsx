...
const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    detailedText: "Charlie suffered from diabetes, requiring twice-daily insulin injections exactly 12 hours apart. With Pet Horizon's shared family alarms, his owners set programmatic alerts. The activity tracking logs also helped maintain a consistent blood glucose plateau, successfully stabilizing Charlie's diabetic markers.",
  ...
  },
  {
    ...
    detailedText: "Luna began self-mutilating and over-grooming due to separation anxiety. Her owners used Pet Horizon to track daily anxiety triggers, food habits, and play timelines. Programmatic behavioral monitoring allowed the family to target grooming sessions with calming triggers, leading to full hair regrowth.",
