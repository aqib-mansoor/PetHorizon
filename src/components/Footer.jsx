...
export default function Footer() {
  return (
    <footer className="bg-emerald-50 text-secondary pt-24 pb-12 relative overflow-hidden border-t border-emerald-100">
      {/* Subtle Glow Effects for Light Mode */}
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none -translate-x-1/3 translate-y-1/3"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Top Grid */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-emerald-200/60 mb-12">
          ...
          >
            <div className="flex items-center space-x-2 text-xl font-bold mb-6">
              <img src={logoImg} alt="Pet Horizon Logo" className="h-10 w-auto object-contain rounded-full bg-white p-1 shadow-sm" />
              <span className="text-secondary tracking-wide">Pet Horizon</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <a href="#facebook" className="bg-white hover:bg-primary border border-emerald-200 hover:border-primary p-2.5 rounded-xl text-emerald-600 hover:text-white transition-all duration-300 shadow-sm" aria-label="Facebook">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z"/>
                </svg>
              </a>
              <a href="#twitter" className="bg-white hover:bg-primary border border-emerald-200 hover:border-primary p-2.5 rounded-xl text-emerald-600 hover:text-white transition-all duration-300 shadow-sm" aria-label="Twitter">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#instagram" className="bg-white hover:bg-primary border border-emerald-200 hover:border-primary p-2.5 rounded-xl text-emerald-600 hover:text-white transition-all duration-300 shadow-sm" aria-label="Instagram">
          ...
          >
            ...
            <div className="flex flex-col gap-3.5 max-w-[140px]">
              ...
              <a
                ...
                className="transition-transform hover:scale-105 duration-200 block"
              >
        ...
        <motion.div 
          ...
          className="flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-4"
        >
